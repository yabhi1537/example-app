        ...
        <div class="modal-content">
            ...
            <form wire:submit="saveStudent">
                <div class="modal-body">
                    ...
                    <select wire:model.lazy="catname" name="catname" id="catname" class="form-control" required>
                        <option value="" >Select Course</option>
                        @foreach($catnameall as $catnam)
                        <option value="{{$catnam->name}}" >{{$catnam->name}}</option>
                        @endforeach
                </select>
                    ...
                    <div class="mb-3">
                        <label>File</label>
                        <input type="file" wire:model.live="photos">
                        @error('course') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form wire:submit="updateStudent">
                <div class="modal-body">
                    ...
                    <!-- <input type="hidden" wire:model.live="photos"> -->
...
<div wire:ignore.self class="modal fade" id="deleteStudentModal" tabindex="-1" aria-labelledby="deleteStudentModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form wire:submit="destroyStudent">
                <div class="modal-body">
